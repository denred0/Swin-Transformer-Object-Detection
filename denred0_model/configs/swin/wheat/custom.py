...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('wheat',),
        ann_file='/content/data_xywh_full_bbox_segm/train_ins.json',
        img_prefix='',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    ...
    val=dict(
        type='CocoDataset',
        classes=('wheat',),
        ann_file='/content/data_xywh_full_bbox_segm/val_ins.json',
        img_prefix='',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='CocoDataset',
        classes=('wheat',),
        ann_file='/content/data_xywh_full_bbox_segm/test_ins.json',
        img_prefix='',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
